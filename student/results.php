...
<?php
$userId = $_SESSION['user_id']; // Assuming 'userID' is the key for storing user ID in the session

// Fetch user data using the user ID
$userData = get_user_data($userId);

// Extract student ID from user data
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <label for="studentID">Student ID: <?php echo $studentID; ?></label>
