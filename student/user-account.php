...
if (isset($_POST['update'])) {
  // Fetch student's details from the form
  $name = $_POST['name'];
  $dob = $_POST['dob'];
  $mobile = $_POST['mobile'];
  $email1 = $_POST['email1'];
  ...
  $update_query_dob = "UPDATE usermeta SET meta_value = '$dob' WHERE meta_key = 'dob' AND user_id = $std_id";
  $update_query_mobile = "UPDATE usermeta SET meta_value = '$mobile' WHERE meta_key = 'mobile' AND user_id = $std_id";
  $update_query_email1 = "UPDATE usermeta SET meta_value = '$email1' WHERE meta_key = 'email1' AND user_id = $std_id";
  $update_query_address = "UPDATE usermeta SET meta_value = '$address' WHERE meta_key = 'address' AND user_id = $std_id";
  $update_query_state = "UPDATE usermeta SET meta_value = '$state' WHERE meta_key = 'state' AND user_id = $std_id";
  $update_query_country = "UPDATE usermeta SET meta_value = '$country' WHERE meta_key = 'country' AND user_id = $std_id";
  $update_query_zip = "UPDATE usermeta SET meta_value = '$zip' WHERE meta_key = 'zip' AND user_id = $std_id";
  $update_query_tenth_percentage = "UPDATE usermeta SET meta_value = '$tenth_percentage' WHERE meta_key = '10th_percentage' AND user_id = $std_id";
  $update_query_school_name = "UPDATE usermeta SET meta_value = '$school_name' WHERE meta_key = 'school_name' AND user_id = $std_id";
  $update_query_twelveth_percentage = "UPDATE usermeta SET meta_value = '$twelveth_percentage' WHERE meta_key = '12th_percentage' AND user_id = $std_id";
  $update_query_school_name2 = "UPDATE usermeta SET meta_value = '$school_name2' WHERE meta_key = 'school_name2' AND user_id = $std_id";
  $update_query_father_name = "UPDATE usermeta SET meta_value = '$father_name' WHERE meta_key = 'father_name' AND user_id = $std_id";
  $update_query_mother_name = "UPDATE usermeta SET meta_value = '$mother_name' WHERE meta_key = 'mother_name' AND user_id = $std_id";
  $update_query_mother_mobile = "UPDATE usermeta SET meta_value = '$mother_mobile' WHERE meta_key = 'mother_mobile' AND user_id = $std_id";
  $update_query_father_occupation = "UPDATE usermeta SET meta_value = '$father_occupation' WHERE meta_key = 'father_occupation' AND user_id = $std_id";
  $update_query_mother_occupation = "UPDATE usermeta SET meta_value = '$mother_occupation' WHERE meta_key = 'mother_occupation' AND user_id = $std_id";
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                      <div class="form-group mt-2 row justify-content-center">
                        <div class="col-auto">
                          ...
                          <label for="profileImage" class="btn btn-info btn-xs"><i class="fas fa-pencil mr-1"></i></label>
                        </div>
                        <div class="col-auto">
                          <button type="submit" class="btn btn-dark btn-xs" name="uploadImage" style="position:relative; top:-3px;"><i class="fas fa-upload mr-1"></i></button>
                        </div>
                      </div>
                    </form>
                  </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="" method="post">
              ...
              <div class="form-group">
                <label for="dob">Personal Email</label>
                <input type="text" class="form-control" id="address" name="email1" value="<?php echo $stdmeta['email1']; ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="dob">10th Percentage</label>
              ...
              <div class="form-group">
                <label for="dob">12th Percentage</label>
